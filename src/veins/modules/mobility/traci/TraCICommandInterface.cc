...
int32_t TraCICommandInterface::Vehicle::getLoadedVehicles()
{
    return traci->genericGetInt(CMD_GET_VEHICLE_VARIABLE, nodeId, ID_COUNT, RESPONSE_GET_VEHICLE_VARIABLE);
}
