...
{
    if(msg->getKind() == 12207){ //WELL MUDAR PARA CLOUD_EVT
        Mac80211Pkt* macMSG = new Mac80211Pkt(msg->getName(), msg->getKind());
        macMSG->setDestAddr(LAddress::L2BROADCAST());
        macMSG->setSrcAddr(myMacAddr);
        sendUp(macMSG);
    }
...
void Mac1609_4::handleLowerControl(cMessage* msg)
{
    ...
    else if(msg->getKind() == 12207){
        //std::cout << "Mac1609_4::handleLowerControl - MODO DEBUG!" << endl;
    }
